...
class Game {
    ...
    setupEventListeners() {
        ...
        this.canvas.addEventListener('touchend', (e) => {
            ...
            const rect = this.canvas.getBoundingClientRect();
            const x = (e.changedTouches[0].clientX - rect.left - this.offsetX) / this.scale;
            const y = (e.changedTouches[0].clientY - rect.top - this.offsetY) / this.scale;
